...
def split_configs(args: Namespace):
    ...
    for marker in marker_set.markers:
        ...
        with open(per_marker_folder / f"{marker.name}.ini", "w") as file:
            ...
            file.write(f"two_step_mutation_fraction = {config.simulation_parameters.two_step_mutation_factor}\n")
            file.write(f"batch_length = {config.simulation_parameters.stability_window}\n")
            file.write(f"convergence_criterion = {config.simulation_parameters.model_validity_threshold}\n")
